    ...
    <div className="font-pretendard flex flex-col rounded-[10px] border border-[#d9d9d9] pt-6 shadow-md">
      <div className="relative self-center">
        ...
        {isAuction && hasDiscount && (
          <div className="text-red absolute right-6 -bottom-7 flex h-14 w-14 items-center justify-center rounded-full bg-transparent text-center text-[40px] font-bold">
